...
## South Korea
stn_info_kr = pd.read_csv(os.path.join(path_in_situ,'AirQuality_SouthKorea','stn_code_lonlat_period_2005_201904.csv'))
...
# new_station = stn
# matlab.savemat(os.path.join(path_stn_kr,'kr_GOCI6km_new_station.mat'],{'new_station':new_station})
...
header_stn_GOCI6km_location = np.array(['scode1','scode2','lat_org','lon_org','pxid','lat_px','lon_px','dist','avgid'],
                                       dtype=h5py.string_dtype(encoding='utf-8'))
fname = 'stn_GOCI6km_location_weight_v201904.mat'
matlab.savemat(os.path.join(path_stn_kr, fname),
