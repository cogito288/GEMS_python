...
for yr in YEARS:
    for mm in range(1, 12+1):
        ...
        for fname in file_list:
            ...
            dstr = [str(x) for x in stn_tbl_temp[:,1]]
        ...
        matlab.savemat(os.path.join(path_stn_jp, 'stn_code_data', f'stn_code_data_{yr}_{mm:02d}.mat'),{'stn_mm':stn_mm})
        print (mm)
    ...
    matlab.savemat(os.path.join(path_stn_jp, 'stn_code_data', f'stn_code_data_{yr}_soramame.mat'),{'stn_yr':stn_yr})
    print (yr)